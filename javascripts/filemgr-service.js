...
FileMgrService.prototype.isInternalzInstalled = function(onSuccess, onFailure) {
	return this.doRequest('isInternalzInstalled', {}, onSuccess, onFailure);
};

FileMgrService.prototype.hideInternalz = function(onSuccess, onFailure) {
	return this.doRequest('hideInternalz', {}, onSuccess, onFailure);
};

FileMgrService.prototype.hideInternalzPro = function(onSuccess, onFailure) {
	return this.doRequest('hideInternalzPro', {}, onSuccess, onFailure);
};
